...
The **Airymax Rust SDK** (`agentrt-rs`, crate `agentrt_rs`) provides a memory-safe, zero-cost-abstraction interface to the Airymax runtime. It is the SDK of choice for performance- and safety-critical workloads.
